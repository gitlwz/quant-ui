...
class Echarts11 extends Component {
  componentDidMount = () => {
    let myChart = echarts.init(document.getElementById("echart11"));
    myChart.setOption(option);
  };

  render() {
    return <div id="echart11" style={{ height: 500, width: "100%" ,marginRight:10}} />;
  }
}

export default Echarts11;
