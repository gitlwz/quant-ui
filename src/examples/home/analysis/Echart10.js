...
class Echarts10 extends Component {
  componentDidMount = () => {
    let myChart = echarts.init(document.getElementById("echart10"));
    myChart.setOption(option);
  };

  render() {
    return <div id="echart10" style={{ height: 500, width: "100%",marginRight:10}} />;
  }
}

export default Echarts10;
