...
class Echarts13 extends Component {
  componentDidMount = () => {
    let myChart = echarts.init(document.getElementById("echart13"));
    myChart.setOption(option);
  };

  render() {
    return <div id="echart13" style={{ height: 500, width: "100%" ,marginRight:10}} />;
  }
}

export default Echarts13;
